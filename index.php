    ...
    <div class="container-fluid">
        ...
        <div class="owl-carousel owl-theme">
            <div class="item popular-item">
                <div class="thumb">
                    <img src="<?php echo get_template_directory_uri() ?> /img/popular_item_1.jpg" alt="">
            ...
            <div class="item popular-item">
                <div class="thumb">
                    <img src="<?php echo get_template_directory_uri() ?> /img/popular_item_2.jpg" alt="">
                    <div class="text-content">
                        <h4>Aenean dolor</h4>
            ...
            <div class="item popular-item">
                <div class="thumb">
                    <img src="<?php echo get_template_directory_uri() ?> /img/popular_item_3.jpg" alt="">
                    <div class="text-content">
                        <h4>Nunc at quam</h4>
            ...
            <div class="item popular-item">
                <div class="thumb">
                    <img src="<?php echo get_template_directory_uri() ?> /img/popular_item_4.jpg" alt="">
                    <div class="text-content">
            ...
            <div class="item popular-item">
                <div class="thumb">
                    <img src="<?php echo get_template_directory_uri() ?> /img/popular_item_5.jpg" alt="">
                    <div class="text-content">
                        <h4>Lorem ipsum</h4>
        ...
        <div class="row">
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="featured-item">
                    <div class="thumb">
                        <img src="<?php echo get_template_directory_uri() ?> /img/featured_item_1.jpg" alt="">
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="featured-item">
                    <div class="thumb">
                        <img src="<?php echo get_template_directory_uri() ?> /img/featured_item_2.jpg" alt="">
                        <div class="overlay-content">
                            <ul>
                                <li><i class="fa fa-star"></i></li>
                                <li><i class="fa fa-star"></i></li>
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="featured-item">
                    <div class="thumb">
                        <img src="<?php echo get_template_directory_uri() ?> /img/featured_item_3.jpg" alt="">
                        <div class="overlay-content">
                            <ul>
                                <li><i class="fa fa-star"></i></li>
                                <li><i class="fa fa-star"></i></li>
